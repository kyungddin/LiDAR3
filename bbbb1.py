...
# 거울 탐지 알고리즘 (v3.30 - Manual Angle Correction)
...
# ▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼ 수동 각도 보정 파라미터 ▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼▼ #
# ================================================================= #
# 이 값을 조절하여 복원 결과의 좌우 각도를 미세 조정할 수 있습니다. (단위: 도)
# 양수: 시계 방향 회전, 음수: 반시계 방향 회전
...
def main():
    ...
    rospy.loginfo("▶ 거울 탐지 및 복원 노드 시작 (v3.30 - Manual Angle Correction)")
    rospy.spin()
